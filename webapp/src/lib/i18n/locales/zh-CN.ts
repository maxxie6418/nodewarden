...
const zhCN: Record<string, string> = {
  ...
  "txt_no_attachments": "暂无附件",
  "txt_marked_for_removal_count": "保存后将删除 {count} 个附件",
  "txt_replace_attachment": "替换附件",
  "txt_trash": "回收站",
...
Object.assign(zhCN, {
  ...
  "txt_cleanup_domain_section": "同域名下的多个账号",
  "txt_cleanup_domain_summary": "{groups} 个域名 · {count} 条",
  "txt_cleanup_domain_help": "按主域名分组（子域名与 www 视为同一站点），仅列出含 2 条及以上的分组，勾选不再需要的条目。",
  "txt_cleanup_domain_empty": "没有包含多个条目的域名分组。",
  "txt_cleanup_select_group": "全选本组",
  "txt_cleanup_select_older_duplicates": "选中重复中的旧条目",
  "txt_cleanup_uri_section": "无法访问的链接",
  "txt_cleanup_uri_summary": "共 {count} 条含链接",
  "txt_cleanup_uri_help": "检测由浏览器发起，结果仅供参考。标记为无法验证的条目可能仍然有效，删除前请先人工确认。",
  "txt_cleanup_uri_start": "开始检测",
  ...
  "txt_cleanup_confirm_message": "将把 {count} 个条目移入回收站，之后可在回收站中恢复。",
...
Object.assign(zhCN, {
  ...
  "txt_cleanup_delete_checked": "删除勾选（{count}）",
  "txt_cleanup_confirm_group_message": "将把「{name}」中勾选的 {count} 个条目移入回收站，之后可在回收站中恢复。"
});
