...
export const DEMO_CIPHERS: Cipher[] = [
  ...
  {
    id: 'cipher-login-example-primary',
    type: 1,
    folderId: 'folder-work',
    favorite: false,
    reprompt: 0,
    name: 'Example 工作邮箱',
    notes: 'Cleanup demo: same main domain, distinct subdomain prefix.',
    decName: 'Example 工作邮箱',
    decNotes: 'Cleanup demo: same main domain, distinct subdomain prefix.',
    creationDate: '2025-11-02T09:00:00.000Z',
    revisionDate: '2026-02-10T10:00:00.000Z',
    login: {
      username: 'zhangsan@example.com',
      password: 'Demo#SamePass1',
      decUsername: 'zhangsan@example.com',
      decPassword: 'Demo#SamePass1',
      uris: [{ uri: 'https://mail.example.com', decUri: 'https://mail.example.com', match: null }],
    },
  },
  {
    id: 'cipher-login-example-dupe',
    type: 1,
    folderId: 'folder-work',
    favorite: false,
    reprompt: 0,
    name: 'Example 官网登录',
    notes: 'Cleanup demo: duplicate pair with the mail.example.com item (same credentials).',
    decName: 'Example 官网登录',
    decNotes: 'Cleanup demo: duplicate pair with the mail.example.com item (same credentials).',
    creationDate: '2024-06-15T08:30:00.000Z',
    revisionDate: '2026-01-20T09:00:00.000Z',
    login: {
      username: 'zhangsan@example.com',
      password: 'Demo#SamePass1',
      decUsername: 'zhangsan@example.com',
      decPassword: 'Demo#SamePass1',
      uris: [{ uri: 'https://www.example.com', decUri: 'https://www.example.com', match: null }],
    },
  },
  {
    id: 'cipher-login-example-staging',
    type: 1,
    folderId: 'folder-devops',
    favorite: false,
    reprompt: 0,
    name: 'Example 测试环境 1',
    notes: 'Cleanup demo: stale test account on the same main domain.',
    decName: 'Example 测试环境 1',
    decNotes: 'Cleanup demo: stale test account on the same main domain.',
    creationDate: '2023-08-01T12:00:00.000Z',
    revisionDate: '2025-03-05T11:00:00.000Z',
    login: {
      username: 'test@example.com',
      password: 'TestAcc#101',
      decUsername: 'test@example.com',
      decPassword: 'TestAcc#101',
      uris: [{ uri: 'https://staging.example.com', decUri: 'https://staging.example.com', match: null }],
    },
  },
  {
    id: 'cipher-login-example-staging2',
    type: 1,
    folderId: 'folder-devops',
    favorite: false,
    reprompt: 0,
    name: 'Example 测试环境 2',
    notes: 'Cleanup demo: another stale test account under the same main domain.',
    decName: 'Example 测试环境 2',
    decNotes: 'Cleanup demo: another stale test account under the same main domain.',
    creationDate: '2023-09-14T15:00:00.000Z',
    revisionDate: '2025-04-18T16:00:00.000Z',
    login: {
      username: 'qa@example.com',
      password: 'TestAcc#102',
      decUsername: 'qa@example.com',
      decPassword: 'TestAcc#102',
      uris: [{ uri: 'https://dev.example.com', decUri: 'https://dev.example.com', match: null }],
    },
  },
  {
    id: 'cipher-login-deadwiki',
    type: 1,
    folderId: 'folder-work',
    favorite: false,
    reprompt: 0,
    name: '旧团队 Wiki（已下线）',
    notes: 'Cleanup demo: retired service whose host no longer resolves.',
    decName: '旧团队 Wiki（已下线）',
    decNotes: 'Cleanup demo: retired service whose host no longer resolves.',
    creationDate: '2022-11-01T09:00:00.000Z',
    revisionDate: '2024-07-01T09:00:00.000Z',
    login: {
      username: 'alice@oldcorp.cn',
      password: 'Legacy#Wiki2023',
      decUsername: 'alice@oldcorp.cn',
      decPassword: 'Legacy#Wiki2023',
      uris: [{ uri: 'https://wiki.oldcorp-defunct-9x2.net', decUri: 'https://wiki.oldcorp-defunct-9x2.net', match: null }],
    },
  },
  {
    id: 'cipher-login-deadforum',
    type: 1,
    folderId: 'folder-personal',
    favorite: false,
    reprompt: 0,
    name: '老社区论坛（已关停）',
    notes: 'Cleanup demo: service decommissioned in 2023.',
    decName: '老社区论坛（已关停）',
    decNotes: 'Cleanup demo: service decommissioned in 2023.',
    creationDate: '2021-05-20T10:00:00.000Z',
    revisionDate: '2023-12-10T10:00:00.000Z',
    login: {
      username: 'demo.bob@legacybbs.org',
      password: 'Forum#2021old',
      decUsername: 'demo.bob@legacybbs.org',
      decPassword: 'Forum#2021old',
      uris: [{ uri: 'http://forum.retiredbbs-2021.org', decUri: 'http://forum.retiredbbs-2021.org', match: null }],
    },
  },
];
