...
import { ArrowUpDown, Cloud, Eraser, FileClock, FileCog, Globe2, LogOut, Settings as SettingsIcon, Shield, ShieldCheck, ShieldUser } from 'lucide-preact';
...
const VaultCleanupPage = lazy(() => import('@/components/VaultCleanupPage'));
...
export default function AppMainRoutes(props: AppMainRoutesProps) {
  ...
  return (
    <Switch>
      ...
      <Route path="/security/vault-cleanup">
        <div className="stack">
          {props.mobileLayout && (
            <div className="mobile-settings-subhead">
              <button type="button" className="btn btn-secondary small mobile-settings-back" onClick={() => props.onNavigate(props.settingsHomeRoute)}>
          ...
          <section className="card mobile-settings-card settings-home-card">
            <div className="settings-home-section">
              ...
              <div className="mobile-settings-links">
                ...
                <Link href="/security/vault-cleanup" className="mobile-settings-link">
                  <Eraser size={18} />
                  <span>{t('nav_vault_cleanup')}</span>
                </Link>
